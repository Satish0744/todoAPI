  ...
  return (
    <div
      className={`
        ...
        flex items-center p-4 mb-3 w-full max-w-xs rounded-lg border-l-4 shadow-lg
        ${getTypeStyles()}
      `}
      role="alert"
    >
      ...
      <button
        ...
        className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex h-8 w-8 hover:bg-gray-100/50"
      >
